...
function updateTimer() {
  const targetDate = new Date("december 6, 2025 20:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '542993261380'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '542993261380'; // Número para el primer botón
